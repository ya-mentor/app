...
angular.module('mentees').controller('SettingsController', ['$scope', '$http', '$location', 'mentees', 'Authentication',
	function($scope, $http, $location, mentees, Authentication) {
		...
		$scope.removementeesocialAccount = function(provider) {
			$scope.success = $scope.error = null;

			$http.delete('/mentees/accounts', {
				params: {
					provider: provider
				}
		...
		$scope.changeUserPassword = function() {
			...
			$http.post('/mentees/password', $scope.passwordDetails).success(function(response) {
				// If successful show success message and clear form
				$scope.success = true;
